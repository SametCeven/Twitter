...
public class RoleRepositoryTest {
    ...
    @DisplayName("findByAuthority, does authority return correct role")
    @Test
    void findByAuthority(){
        ...
        Optional<Role> foundRole = roleRepository.findByAuthority(role.getAuthority());

        Assertions.assertTrue(foundRole.isPresent());
        Assertions.assertEquals(role.getAuthority(), foundRole.get().getAuthority());
    }
